...
// Enable USB CDC via TinyUSB
#ifndef MICROPY_HW_USB_CDC
#define MICROPY_HW_USB_CDC                  (CONFIG_USB_OTG_SUPPORTED)
#endif

// Enable stdio over USB serial / JTAG
ifndef MICROPY_HW_ESP_USB_SERIAL_JTAG
#define MICROPY_HW_ESP_USB_SERIAL_JTAG      (!MICROPY_HW_USB_CDC && (CONFIG_ESP_CONSOLE_USB_SERIAL_JTAG_ENABLED || (ESP_IDF_VERSION < ESP_IDF_VERSION_VAL(5, 1, 0) && (CONFIG_ESP_CONSOLE_SECONDARY_USB_SERIAL_JTAG || CONFIG_ESP_CONSOLE_USB_SERIAL_JTAG))))
(!MICROPY_HW_USB_CDC && (CONFIG_ESP_CONSOLE_USB_SERIAL_JTAG_ENABLED || (ESP_IDF_VERSION < ESP_IDF_VERSION_VAL(5, 1, 0) && (CONFIG_ESP_CONSOLE_SECONDARY_USB_SERIAL_JTAG || CONFIG_ESP_CONSOLE_USB_SERIAL_JTAG))))
